...
const Navbar = () => {
  ...
  // Ensure no duplicate items in the navItems array
  const navItems = ['home', 'about', 'work', 'skills', 'contact'];

  return (
    <header style={{ background: "rgba(255,255,255,0.25)", backdropFilter: "blur(4px)", border: "1px solid rgba(255,255,255,0.18)" }}>


      <nav className="container mx-auto px-4 py-8" >
        <div className="md:flex hidden sticky z-20 justify-between items-center">
          {/* logo */}
          <div className="flex items-center justify-center">
            <h1 className="font-bold font-serif text-3xl">JMD</h1>
            {/* <img className="object-cover" src={images.logo} alt="Logo" /> */}
          </div>
