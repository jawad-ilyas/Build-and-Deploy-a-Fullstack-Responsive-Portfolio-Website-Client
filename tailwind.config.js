...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        primaryColor: "#edf2f8!important",   /* Tailwind: bg-blue-50 */
        secondaryColor: "#313bac!important", /* Tailwind: bg-indigo-600 */
        blackColor: "#030303",     /* Tailwind: bg-black */
        lightGrayColor: "#e4e4e4", /* Tailwind: bg-gray-200 */
        grayColor: "#6b7688!important",      /* Tailwind: bg-gray-600 */
